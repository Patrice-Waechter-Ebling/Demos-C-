...
namespace Laboratoire4_POO
{
    internal class Commande:Queue
    {
        ...
        public void AjouterItem(Menu menu){this.Enqueue(new Commande(menu.GetTitre(), 1, menu.GetPrix()));}
        public void AjouterItem(string plat, int quantite, double prixUnitaire){
            ...
            this.Enqueue(new Commande(plat, quantite, prixUnitaire));
        }
