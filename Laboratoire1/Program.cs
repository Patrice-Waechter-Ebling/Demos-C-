...
namespace Laboratoire1
{
    class Program
    {
        ...
        static Produit[] produitsPossibles = null;
        ...
        static void CreerTableProduits()
        {
            produitsPossibles = new Produit[10];
            produitsPossibles[0] = new Produit(1, "Patate", 3.23);
            produitsPossibles[1] = new Produit(2, "Steak", 6.42);
            produitsPossibles[2] = new Produit(3, "Carotte", 1.98);
            produitsPossibles[3] = new Produit(4, "Nain de jardin", 38.38);
            produitsPossibles[4] = new Produit(5, "Jus de pomme", 83.35);
            produitsPossibles[5] = new Produit(6, "Beau jeans bleus", 5.86);
            produitsPossibles[6] = new Produit(7, "Roche multicolore", 132.65);
            produitsPossibles[7] = new Produit(8, "Cactus pas trop piquant", 12.36);
            produitsPossibles[8] = new Produit(9, "Peanuts", 7.57);
            produitsPossibles[9] = new Produit(10, "Spaghetti", 52.33);
        }
